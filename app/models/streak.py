...
class Streak(BaseModel):
    ...
    streak_type = Column(String(50), nullable=False)  # daily_practice, weekly_goal, concept_mastery
    ...
    # Streak Metadata
    difficulty_level = Column(String(20), default="normal")  # easy, normal, hard, custom
